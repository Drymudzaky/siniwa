  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><b>SIM-KSK</b></a>
            <!--logo end-->
            <div class="top-menu">
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h3>&raquo; DATA NILAI KSK MAHASISWA</h3>
                      </div>
              
                      <div class="col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-user"></i> Nilai KSK Mahasiswa : <?php echo $_SESSION['nama']; ?> </h3> 
                        </div>
                        <div class="panel-body">
                        <center><h3>DATA NILAI SEMESTER SISWA</h3></center>
                           <center><h3>Nilai KSK</h3></center>
                    <?php
                    $siswa = $_SESSION['kode'];
                    ...
                    <table width="500">
                    <tr>
                        <td width="100">Kode Mahasiswa</td> <td>:</td> <td><?php echo $d['kode_siswa']; ?></td> 
                    </tr>
                    <br />
                    <tr>
                        <td width="100">Npm</td> <td>:</td> <td><?php echo $d['nis']; ?></td>
                    </tr>
                    <br />
                    <tr>
