      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Mahasiswa &raquo; Input Mahasiswa</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Input Mahasiswa</h4>
                      <form class="form-horizontal style-form" action="insert-siswa.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode Mahasiswa</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="npm" type="text" id="npm" class="form-control" placeholder="Nomor Pokok Mahasiswa" required />
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="email" class="form-control" id="email" type="text" placeholder="Masukan Email" required />
                              </div>
                          </div>
                          <div class="form-group">
