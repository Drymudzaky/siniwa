      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Kelas Mahasiswa &raquo; Data Kelas Mahasiswa</h3><br /><br />
          	<!--<div class="row mt">
              <div class="col-lg-4">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='kelas-siswa.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-book"></i> Data Kelas Mahasiswa </h3> 
                        </div>
                        <div class="panel-body">
                        <div class="table-responsive">
                    <?php
                    $query1="SELECT kelas_siswa.id, kelas_siswa.kode_siswa, kelas_siswa.jurusan, kelas.tahun_ajar, kelas.kelas, kelas.nama_ksk, guru.level_ksk,
                            siswa.nis, siswa.nama_siswa, siswa.tahun_angkatan
                            FROM kelas_siswa, kelas, guru, siswa
                            WHERE kelas_siswa.kode_kelas=kelas.kode_ksk AND
                            kelas.level_ksk=guru.level_ksk AND siswa.kode_siswa=kelas_siswa.kode_siswa";
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        ...
                        <th>Nama Dosen <i class="fa fa-sort"></i></th>
                        <th>NPM <i class="fa fa-sort"></i></th>
                        <th>Nama Mahasiswa <i class="fa fa-sort"></i></th>
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="input-kelas-siswa.php" class="btn btn-sm btn-warning">Tambah Kelas Mahasiswa <i class="fa fa-arrow-circle-right"></i></a>
