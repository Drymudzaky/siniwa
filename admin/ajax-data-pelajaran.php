...
$sql = "SELECT kode_ksk, nama_ksk, jurusan, level_ksk, ksk_ekbis";
$sql.=" FROM ekbisksk";
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql.=" OR ksk_ekbis LIKE '".$requestData['search']['value']."%' ";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = $row["ksk_ekbis"];
    $nestedData[] = '<td><center>
                     <a href="edit-pelajaran.php?kd='.$row['kode_ksk'].'"  data-toggle="tooltip" title="Edit" class="btn btn-sm btn-primary"> <i class="glyphicon glyphicon-edit"></i> </a>
				     <a href="hapus-pelajaran.php?kd='.$row['kode_ksk'].'"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama_ksk'].'?\')" class="btn btn-sm btn-danger"> <i class="glyphicon glyphicon-trash"> </i> </a>
	                 </center></td>';		
