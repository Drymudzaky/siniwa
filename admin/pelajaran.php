          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-book"></i> Jenis KSK Ekonomi Bisnis </h3> 
                        </div>
                        <div class="panel-body">
                        <div class="table-responsive">
                        <a href="input-pelajaran.php" class="btn btn-sm btn-warning">Tambah Jenis KSK <i class="fa fa-arrow-circle-right"></i></a><br /><br />
