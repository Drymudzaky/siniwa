...
<?php } ?>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      $namaksk 	= isset($_POST['cmbnamaksk']) ? $_POST['cmbnamaksk'] : '';
...
elseif(isset($_POST['btnPilih2'])) {
	$filterSQL = " WHERE nilai.kode_kelas = '$dataKelas' AND nilai.kode_ksk = '$datanamaksk'";
}
elseif(isset($_POST['btnPilih3'])) {
	$filterSQL = " WHERE nilai.kode_kelas = '$dataKelas' AND nilai.kode_ksk = '$datanamaksk' AND nilai.semester = '$dataSemester'";
}
else {
	$filterSQL = "";
}
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Nilai &raquo; Data Nilai Mahasiswa</h3><br /><br />
         	 <div class="row mt">
              <div class="col-lg-4">
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="input-nilai.php" class="btn btn-sm btn-warning">Input Nilai Mahasiswa <i class="fa fa-arrow-circle-right"></i></a>
