    ...
    <div id="login-page">
        <div class="container">
            ...
            <form class="form-login" method="post" action="proseslogin-guru.php">
                <h2 class="form-login-heading"> <span class="glyphicon glyphicon-lock"></span> LOGIN DOSEN</h2>
                <center>
                ...
                <div class="login-wrap">
                    <input name="username" id="username" type="input" class="form-control" autocomplete="off" placeholder="Username Dosen" required autofocus>
                    <br />
                    <input name="password" id="password" type="password" class="form-control" autocomplete="off" placeholder="Password Dosen" required>
                    <br />
