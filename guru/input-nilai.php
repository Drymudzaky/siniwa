...
<html lang="en">
  <head>
    ...
    <title>SIM-KSK | Sistem Informasi Manajemen KSK</title>
      ...
      *********************************************************************************************************************************************************** -->
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Data KSK</h4>
                      <form class="form-horizontal style-form" action="insert-nilai.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <h4 class="mb"><i class="fa fa-angle-right"></i> Data Mahasiswa</h4>
                          <div class="form-group">
      ...
      <footer class="site-footer">
          <div class="text-center">
              SIM-KSK &copy; Sistem Informasi Manajemen KSK
